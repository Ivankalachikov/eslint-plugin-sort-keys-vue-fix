 ...
 */
 ...
 module.exports = {
   ...
   isVueFile(path, context) {
    const vueFilesPathPatterns = context.options[1].vueFilesPathPatterns;
    return [...vueFilesPathPatterns, /.vue$/, /.jsx$/].some((vueFilesPathPattern) => path.match(vueFilesPathPattern))
   },
